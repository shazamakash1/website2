      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {notices.map((notice, index) => (
            <div
              key={notice.id}
              className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow border-l-4 border-amber-500 animate-fade-in-up"
            ...
            >
              <div className="flex justify-between items-start gap-4">
                ...
                <button
                  ...
                  className="flex-shrink-0 flex items-center gap-2 bg-slate-100 hover:bg-amber-100 text-slate-600 hover:text-amber-700 font-semibold px-3 py-2 rounded-md transition-colors text-sm"
              ...
              <p className="mt-3 text-slate-700">{notice.content}</p>
            </div>
          ))}
        </div>
      </div>
